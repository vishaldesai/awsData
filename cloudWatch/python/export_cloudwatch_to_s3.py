...
## 2. Add record in dynamodb table with partition key and timestamp from where you want to start copying logs from                                          ###
###############################################################################################################################################################
## Usage:python export_cloudwatch_to_s3.py --region us-east-1 --ddb cloudwatch6 --ddbstream cloudwatchtod0 --secondstoprocess 10800                         ###
###############################################################################################################################################################
